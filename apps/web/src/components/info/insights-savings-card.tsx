...
export function InsightsSavingsCard({ metrics }: InsightsSavingsCardProps) {
  const growthColor =
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <MetricLabel
              title="流動資産"
              description="銀行・電子マネー・貯蓄など、すぐに現金化できる資産の合計です。"
            />
            <div className="text-xl font-semibold">
          ...
          <div>
            <MetricLabel
              title="緊急予備資金"
              description="流動資産 ÷ 月平均支出。収入がゼロになった場合、現在の流動資産で何ヶ月生活できるかを示します。一般的に6ヶ月分以上が目安です。"
            />
            <div className="text-xl font-semibold">
