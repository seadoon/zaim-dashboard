...
function ratioColor(ratio: number) {
  ...
  if (ratio < 30) return "text-yellow-700";
  return "text-balance-negative";
}

export function InsightsLiabilityCard({ metrics }: InsightsLiabilityCardProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <MetricLabel
              title="負債総額"
              description="Zaimのカテゴリ「カード」に登録されているクレジットカードの未払い残高合計です。"
            />
